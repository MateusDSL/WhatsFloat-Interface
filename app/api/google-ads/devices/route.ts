...
import { devicesQuerySchema, validateUrlParams, formatValidationErrors } from '@/lib/validation-schemas';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let validatedParams;
    try {
      validatedParams = validateUrlParams(devicesQuerySchema, searchParams);
    } catch (error) {
